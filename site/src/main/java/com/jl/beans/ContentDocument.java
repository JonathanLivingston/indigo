...
@HippoEssentialsGenerated(internalName = "indigo:contentdocument")
@Node(jcrType = "indigo:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "indigo:introduction")
    public String getIntroduction() {
        return getProperty("indigo:introduction");
    }
    ...
    @HippoEssentialsGenerated(internalName = "indigo:publicationdate")
    public Calendar getPublicationDate() {
        return getProperty("indigo:publicationdate");
    }
}
