              ...
              <nav>
                <ul class="" id="language">
                  ...
                  <li class="active"><i class="fa fa-ellipsis-h"></i> <span>United States</span>
                    <ul>
                      <li><a href="<@hst.webfile path='fr.html'/>">France</a></li>
                    </ul></li>
        ...
        <div class="container">
          ...
          <div class="row header">
            ...
            <div class="col-xs-2 logo">
              <a href="<@hst.webfile path="index.html"/>" <img src="<@hst.webfile src="images/gogreenlogo2.png"/>" alt="" height="107""/> </a>
            </div>
            <!-- //Logo// -->
            ...
            <div class="col-md-12">
              ...
              <nav>
                <ul class="navigation" id="main-navigation">
                  <li><a href="<@hst.webfile path="index.html" class="activelink"><span class="label-nav"/>">Home</span> </a></li>
                  <li><a href="<@hst.webfile path="news.html"><span class="label-nav"/>">News</span></a></li>
                  <li><a href="<@hst.webfile path="blogs.html"><span class="label-nav"/>">Blogs</span></a></li>
                  <li><a href="<@hst.webfile path="events.html"><span class="label-nav"/>">Events</span></a></li>
                  <li><a href="<@hst.webfile path="products.html"><span class="label-nav"/>">Products</span></a></li>
                  <li><a href="<@hst.webfile path="about.html"><span class="label-nav"/>">About</span></a></li>
                </ul>
              </nav>
          ...
          <div class="footer-wrapper">
            <div class="row">
              ...
              <div class="col-md-3 col-sm-3 footer-col">
                <div class="footer-content">
                  <div class="footer-content-logo">
                    <a href="<@hst.webfile path="http://www.onehippo.com" target="_blank"> <img src="<@hst.webfile src="images/logo-hippo.png"/>"/>"
                      alt="onehippo.com" />
                    </a>
                  </div>
                </div>
              ...
              <div class="col-md-3 col-sm-3 footer-col">
                ...
                <div class="footer-content footer-recent-tweets-container">
                  <ul class="footer-category-list">
                    <li><a href="<@hst.webfile path="rss"/>">RSS</a></li>
                  </ul>
                </div>
              </div>
              <!-- //Footer Col.// -->
              ...
              <div class="col-md-3 col-sm-3 footer-col">
                ...
                <div class="footer-content">
                  <ul class="footer-category-list">
                    <li><a href="<@hst.webfile path="news.html"/>">News</a></li>
                    <li><a href="<@hst.webfile path="events.html"/>">Events</a></li>
                    <li><a href="<@hst.webfile path="blogs.html"/>">Blogs</a></li>
                    <li><a href="<@hst.webfile path="products.html"/>">Products</a></li>
                    <li><a href="<@hst.webfile path="about.html"/>">About</a></li>
                  </ul>
                </div>
              </div>
              <!-- //Footer Col.// -->
